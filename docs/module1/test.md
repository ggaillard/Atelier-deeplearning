...
## ⚙️ Étape 1: Configuration de l'environnement Colab (5 minutes)
...
1. **Test avec dessins à la souris**
   ...
   - Répétez ce processus avec au moins 5 chiffres différents
...
3. **Analyse des feature maps**
   - Cochez la case "Visualiser les feature maps"
   - Dessinez un nouveau chiffre et cliquez sur "Prédire"
   - Observez attentivement les feature maps qui s'affichent
   - Notez ce que vous pouvez interpréter de ces visualisations
...
# Ajouter les résultats observés pendant vos tests
# Remplacez par vos propres données observées durant les tests
...
À la fin de la session, vous devrez fournir deux documents:

1. **Copie du notebook Colab** contenant:
   - Tout le code du projet fonctionnel
   - Les résultats documentés de vos tests
   - Vos observations et analyses dans les cellules appropriées

2. **Fiche d'observations CNN** complétée avec:  
   - Les observations sur l'architecture CNN utilisée
   - L'analyse des visualisations des feature maps
   - Les points forts et limitations identifiés
   - Vos propositions d'amélioration

### Modalités de remise

Pour le notebook Colab:
...
- Complétez le document [Fiche d'observations CNN](ressources/Partie2-Phase1-fiche-observationsCNN.md)
- Soumettez-le selon les instructions de votre formateur
