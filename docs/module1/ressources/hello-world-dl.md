...
Ce notebook vous guidera à travers la création, l'entraînement et l'utilisation d'un réseau de neurones pour reconnaître des chiffres manuscrits. Copiez chaque cellule dans votre notebook Google Colab et exécutez-les dans l'ordre.

## Cellule 1 : Introduction (Cellule Markdown)
...
## Cellule 3 : Chargement des données (Cellule Code)
...
## Cellule 4 : Création du modèle (Cellule Code)
...
## Cellule 5 : Entraînement (Cellule Code)
...
## Cellule 6 : Visualisation (Cellule Code)
...
## Cellule 7 : Prédictions (Cellule Code)
...
## Cellule 8 : Dessin interactif (Cellule Code)
...
## Cellule 9 : Expérimentation (Cellule Markdown)
